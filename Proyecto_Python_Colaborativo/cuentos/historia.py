# Este es el contenido de: cuentos/historia.py

def imprimir_cuento_base():
    """Imprime el inicio de la narrativa."""
    print("--- El Viaje del Bit ---")
    print("El pequeño bit buscaba una conexión estable y veloz.")
    print("En su travesía, encontró varios obstáculos y aliados.")
